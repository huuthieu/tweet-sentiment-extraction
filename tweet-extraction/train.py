...
from transformers import BartTokenizer, RobertaTokenizer,  AdamW, get_linear_schedule_with_warmup, get_constant_schedule, XLNetTokenizer, AutoTokenizer, BertweetTokenizer, DistilBertTokenizer
...
if args.model == "bertweet":
    # tokenizer = BertweetTokenizer(pretrained_path = '/media/aiteam/storage/AI_DATA/data/pretrain_model/nlp/bertweet-base/')
    # config = RobertaConfig.from_pretrained("/media/aiteam/storage/AI_DATA/data/pretrain_model/nlp/bertweet-base/config.json")
    # model = RobertaForSentimentExtraction.from_pretrained('/media/aiteam/storage/AI_DATA/data/pretrain_model/nlp/bertweet-base/pytorch_model.bin', config=config)

    tokenizer = AutoTokenizer.from_pretrained('vinai/bertweet-base')
    model = RobertaForSentimentExtraction.from_pretrained('vinai/bertweet-base', output_hidden_states=True)
...
#     model = BartForSentimentExtraction.from_pretrained('./bart-configs', output_hidden_states=True)
    ...
    model = DistilBertForSentimentExtraction.from_pretrained('distilbert-base-uncased-distilled-squad', output_hidden_states=True)
